...
public class DoctorAppointmentController {
    ...
    private void filterRecordsCombined(String keyword) {
        ...
        List<Appointment> allAppointmentsByDoctor = appointmentDAO.getAppointmentsByDoctorId(LoginController.loggedInDoctor.getId());

        List<Appointment> filtered = allAppointmentsByDoctor.stream()
                .filter(appointment -> {
