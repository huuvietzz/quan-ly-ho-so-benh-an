...
public class PatientMainController  {
    ...
    public void initialize() {
        loadPage("/Fxml/PatientDashboard.fxml");

        if (LoginController.loggedInPatient != null) {
            userNameLabel.setText("Xin chào, " + LoginController.loggedInPatient.getUserName());
    ...
    public void appointment(ActionEvent event) {
        loadPage("/Fxml/PatientAppointment.fxml");
    }

    @FXML
    public void medicalRecord(ActionEvent event) {
        loadPage("/Fxml/PatientMedicalRecord.fxml");
    }
