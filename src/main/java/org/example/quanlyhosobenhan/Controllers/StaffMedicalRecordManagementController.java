...
public class StaffMedicalRecordManagementController {
...
//    }
    ...
    void update(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/StaffUpdateMedicalRecordForm.fxml"));
            Parent root = loader.load();

            StaffUpdateMedicalRecordFormController controller = loader.getController();
            controller.setMedicalRecordManagementController(this);
